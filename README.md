...
> complete. The application launches with a basic window shell, and
> `core/` can recursively enumerate a directory and produce chunked
> SHA-256 `FileRecord`s for every readable file; it is not yet wired into
> the GUI. Baselines, scanning, and reporting land in subsequent runs. See

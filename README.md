...
> application can recursively enumerate a directory and hash every
> readable file (`core/`), but this is not yet wired into the GUI or
> persisted as a baseline -- that lands in subsequent runs. See

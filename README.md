...
> **Status:** Run 2 (Hashing and Filesystem Engine) complete. The core
> engine can recursively enumerate a directory and hash every readable
> file with SHA-256; baselines, scanning/comparison, and GUI wiring land

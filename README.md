...
> **Status:** Run 2 (Hashing and Filesystem Engine) complete. The
> application launches with a basic window shell and can recursively hash
> a directory's files under the hood; baselines, scan comparison, and GUI

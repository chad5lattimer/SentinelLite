...
> working, independently-tested core engine for recursive file enumeration
> and SHA-256 hashing; it is not yet wired into the GUI. Baselines,
> scanning, and reporting land in subsequent runs. See

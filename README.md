...
> export the most recent scan's results to CSV or JSON. Optional Windows
> Task Scheduler integration and packaging land in Run 7 (deferred without
> compromising MVP stability, per `PROJECT_SPEC.md` section 31). See
